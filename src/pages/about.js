...
export default () => (
  <div>
    ...
    <p>I hope to contribute to making the engineering spaces I am a part of positive and welcoming for all.
      I want people to feel comfortable entering the engineering world without insecurity or fear, so that way they can use their own positive traits to
      participate and grow however they see fit.
    </p>
    <p>This blog was built using Gatsby.js and React, and is under construction.</p>
  </div>
);
