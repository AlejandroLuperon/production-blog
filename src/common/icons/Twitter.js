...
class Twitter extends React.Component {
  ...
  handleOnClick() {
    window.open('https://twitter.com/buildwhatever', '_blank');
  }

  render() {
    return (
      <svg onClick={this.handleOnClick.bind(this)} version="1.1" id="White" x="0px" y="0px"
      	 viewBox="0 0 400 400" style={{enableBackground: 'new 0 0 400 400'}} className="social icon">
        <path style={{fill:'#000000'}} d="M400,200c0,110.5-89.5,200-200,200S0,310.5,0,200S89.5,0,200,0S400,89.5,400,200z M163.4,305.5
